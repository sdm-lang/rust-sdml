...
msg_library_definition_not_allowed = definition type not allowed in non-library module
msg_dimension_parent_not_entity = parent target type is not an entity definition
msg_source_entity_not_entity = sourced target type is not an entity definition
msg_source_entity_missing_member = sourced member is not a member of the target entity
